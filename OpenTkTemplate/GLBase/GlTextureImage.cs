...
namespace OpenTkTemplate.GLBase
{
    ...
    public class GlTextureImage
    {
        ...
        public static GlTextureImage LoadFromFile(string path)
        {
            // Generate handle
            ...
            GlTextureImage result= new GlTextureImage(handle);
            // Load the image
            using (Bitmap image = new Bitmap(path))
            {
                ...
                //image.RotateFlip(RotateFlipType.RotateNoneFlipY);//removed this for now 
        ...
        public GlTextureImage(int glHandle)
        {
            Handle = glHandle;
        }
